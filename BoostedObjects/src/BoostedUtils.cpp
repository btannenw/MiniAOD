...
bool BoostedUtils::FirstHasHigherCSV(pat::Jet jet1,pat::Jet jet2){
  return BoostedUtils::GetJetCSV(jet1,"pfCombinedInclusiveSecondaryVertexV2BJetTags") > BoostedUtils::GetJetCSV(jet2,"pfCombinedInclusiveSecondaryVertexV2BJetTags");
}
...
bool BoostedUtils::PassesCSV(const pat::Jet& jet, const char workingPoint){
  ...
  float csvValue = BoostedUtils::GetJetCSV(jet,"pfCombinedInclusiveSecondaryVertexV2BJetTags");
